...
namespace ApiCatalogoJogos.Controllers.V1 {
    ...
    public class JogosController : ControllerBase {
        ...
        /// <response code = "204">Caso não haja um jogo com este Id.</response>
        [HttpGet("{idJogo:guid}")]
        public async Task<ActionResult<List<JogoViewModel>>> Obetr([FromRoute] Guid idJogo) {
        ...
        public async Task<ActionResult> AtualilzarJogo([FromRoute] Guid idJogo, [FromRoute] double preco) {
            try {
